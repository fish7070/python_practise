...
class CustomerProfile:
    ...
    def __init__(self, first_name, last_name, profile_id, service_level, obj_address):
...
def main():
    ...
    obj_address2 = "123 Baker Street, Boston, MA"
    obj_customer1 = CustomerProfile("Tom", "Key", "P1001", "SL101", obj_address2)
